...
import com.example.myapplicationtest.databinding.CalculatorLayoutBinding
...
//            var num1 = binding.num1Input.text.toString().toInt()
//            var num2 = binding.num2Input.text.toString().toInt()
//            var sum = num1 + num2
//            binding.output.text = sum.toString()
//        }
